"""
Improved accuracy over previous model by including words removed by TFIDF filter, but
removing stop words. 
"""
...
vec = CountVectorizer(stop_words='english', ngram_range=(1,2)).fit(x_train)
...
# Accuracy with ommitting TFIDF, but removing stop_words .954
